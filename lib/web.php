...
function mahara_standard_nav() {
    ...
    $menu = array(
        ...
        'content' => array(
            ...
            'title' => get_string('profile', 'view'),
            'weight' => 20,
        ),
        'myportfolio' => array(
            'path' => 'myportfolio',
            'url' => 'view/index.php',
            'title' => get_string('myportfolio', 'view'),
            'weight' => 30,
            'accesskey' => 'v',
        ),
        'myportfolio/files' => array(
            'path' => 'myportfolio/files',
            'url' => 'artefact/file/index.php',
            'title' => get_string('Files', 'view'),
            'weight' => 10,
        ),
        'myportfolio/blogs' => array(
            'path' => 'myportfolio/blogs',
            'url' => 'artefact/blog/view/index.php',
            'title' => get_string('Journal', 'view'),
            'weight' => 20,
        ),
        ...
        'groups' => array(
            ...
            'title' => get_string('mycourses', 'view'),
            'weight' => 40,
            'accesskey' => 'g',
        ),
        'groups/mygroups' => array(
            ...
            'url' => 'group/mygroups.php',
            'title' => get_string('courses', 'view'),
            'weight' => 10,
        ),
        'groups/find' => array(
            'path' => 'groups/find',
            'url' => 'group/find.php',
            'title' => get_string('findcourses', 'view'),
            'weight' => 20,
        ),
        'groups/myfriends' => array(
            'path' => 'groups/myfriends',
            'url' => 'user/myfriends.php',
            'title' => get_string('peers', 'view'),
            'weight' => 30,
        ),
        'groups/findfriends' => array(
            'path' => 'groups/findfriends',
            'url' => 'user/find.php',
            'title' => get_string('findpeers', 'view'),
            'weight' => 40,
        ),
